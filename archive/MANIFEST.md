...
| `index-1.0.0-differ.html` | 1.0.0-differ | 1 · Differ | #26 | — | Crowd modal, per-person traits, Apply then Reset, fair-eat |
| `index-1.0.1-stories.html` | 1.1.0-stories (file named 1.0.1 by mistake) | 1 · Differ | (local) | — | Crowd stories, Help rewrite, food gap 1–20. Same freeze as 1.1.0. |
